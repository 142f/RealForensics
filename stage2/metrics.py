...
try:
    ...
    def _auroc_update(preds, targets):
        return preds, targets.int(), "binary"

    def _auroc_compute(preds, targets, mode, num_classes=None, pos_label=None, average="macro", max_fpr=None):
        return binary_auroc(preds, targets.int(), max_fpr=max_fpr)
